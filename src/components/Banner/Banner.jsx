        ...
        <div className="flex flex-col justify-center">
          <div className="text-center md:text-left space-y-4 lg:max-w-[450px]">
            <motion.h1
              ...
              initial="hidden"
              whileInView="show"
              className="text-3xl lg:text-4xl font-semibold font-bold font-handwriting"
            >
            ...
            <motion.button
              ...
              initial="hidden"
              whileInView="show"
              className="!mt-5 ml-16 border-2 border-primary text-primary px-6 py-2 rounded-md hover:bg-primary hover:text-white duration-200"
